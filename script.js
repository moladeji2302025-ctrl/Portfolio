window.projects = [
  ...
  {
    id: 'war-story-1',
    title: 'War Story - Style 1',
    category: 'Animations',
    subcategory: 'War Story',
    date: 'July 2026',
    summary: 'Narrative battle sequence rendered in its first stylized pass',
    thumbnail: 'projects/Animations/War story refined.mov',
    mediaType: 'video',
    mediaSrc: 'projects/Animations/War story refined.mov',
    description:
      'First rendering pass of a narrative war story sequence, establishing the core animation, pacing, and camera work before the shading style was iterated on in later passes.',
    tools: ['Blender'],
    gallery: [],
    links: [],
  },
  {
    id: 'war-story-2',
    title: 'War Story - Style 2',
    category: 'Animations',
    subcategory: 'War Story',
    date: 'July 2026',
    summary: 'Second stylistic render exploring an alternate look for the same sequence',
    thumbnail: 'projects/Animations/War story refined_1.mp4',
    mediaType: 'video',
    mediaSrc: 'projects/Animations/War story refined_1.mp4',
    description:
      'Second render of the war story sequence, revisiting shading and lighting to explore a different visual treatment while keeping the same animation and camera work.',
    tools: ['Blender'],
    gallery: [],
    links: [],
  },
  {
    id: 'war-story-3',
    title: 'War Story - Style 3',
    category: 'Animations',
    subcategory: 'War Story',
    date: 'July 2026',
    summary: 'Final refined render of the war story sequence with polished visual style',
    thumbnail: 'projects/Animations/War story refined_2.mp4',
    mediaType: 'video',
    mediaSrc: 'projects/Animations/War story refined_2.mp4',
    description:
      'Final refined render in the war story series, bringing together the strongest elements of earlier style passes into a polished, cohesive presentation of the sequence.',
    tools: ['Blender'],
    gallery: [],
    links: [],
  },
